...
<?php echo $this->tag->stylesheetLink('css/form-elements.css'); ?>
                ...
                <div class="container">
                    <div class="row">
						...
						<div class="form-group">
			                        ...
			                        <?php echo $this->tag->submitButton(array('Sign Me Up', 'class' => 'btn btn-success')); ?>
...
<?php echo $this->tag->javascriptInclude('js/jquery.backstretch.min.js'); ?>
        
<?php echo $this->tag->javascriptInclude('js/retina-1.1.0.min.js'); ?>

...
<html lang="en">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>PlayMyList</strong> Login</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to our site
					<?php echo "<h1>".$wrong."</h1>";?></h3>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="http://localhost/playmylist/login" method="post" class="login-form">
	...
	{{ javascript_include("js/scripts.js") }}
        ...
        <!--[if lt IE 10]>
		{{ javascript_include("js/placeholder.js") }}
        <![endif]-->
 <footer>
            <div class="row">
                <div class="col-lg-12">
